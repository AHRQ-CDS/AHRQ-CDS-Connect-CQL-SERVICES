...
const DEFAULT_EXEC_EP = 'http://localhost:3000/api/library/USPSTF_Statin_Use_for_Primary_Prevention_of_CVD_in_Adults_FHIRv102/version/1.0.0';
const DEFAULT_EXEC_MSG = path.join('test', 'fixtures', 'exec', 'unhealthy_patient.json');
program
  .command('exec-post')
  .alias('ep')
...
const DEFAULT_HOOKS_MSG = path.join('test', 'fixtures', 'hooks', 'unhealthy_patient.json');
program
  .command('hooks-call')
  .alias('hc')
